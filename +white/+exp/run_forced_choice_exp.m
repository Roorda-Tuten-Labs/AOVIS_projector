function [params, abc] = run_forced_choice_exp(window, params, cal, hue)
    ...
    stim.show_text(window, message1, message2);
    ...
    % run the program
    [data_record, hue_angle, abc] = exp.forced_choice_trial(window, params, cal);
    ...
    if ~strcmp(data_record, 'end')
        ...
        fil.save_to_file(data_record, params.subject, hue, params);
    end
end